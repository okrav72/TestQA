...
* Добавление новой картинки в базу
	...
	И я выбираю файл '$КаталогПроекта$\Features_IRP\Files\itempicture2.png'
...
* Выбор файла картинки из списка
	И в таблице 'Список' я перехожу к строке:
		| "Код"       | "Наименование"     |
		| "000000017" | "itempicture1.png" |
	И я нажимаю на кнопку с именем 'ФормаВыбрать'
	И я нажимаю на кнопку с именем 'ОбновитьКартинку'
	И я нажимаю на кнопку с именем 'ФормаЗаписать'
* Проверка, что картинка сохранилась
	И элемент формы с именем 'Картинка' стал равен 'e1cib/data/Справочник.ХранимыеФайлы.ДанныеФайла?ref=913b005056010f3111efc1d0d4cadef2'
